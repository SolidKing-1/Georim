export const COUNTRY_LIST = [
  ...
  { name: "Bolivia, Plurinational State of", iso: "bo", code: "+591" },
  ...
  { name: "Congo, The Democratic Republic of the", iso: "cd", code: "+243" },
  ...
  { name: "Falkland Islands (Malvinas)", iso: "fk", code: "+500" },
  ...
  { name: "Holy See (Vatican City State)", iso: "va", code: "+379" },
  ...
  { name: "Iran, Islamic Republic of", iso: "ir", code: "+98" },
  ...
  { name: "Korea, Democratic People's Republic of", iso: "kp", code: "+850" },
  { name: "Korea, Republic of", iso: "kr", code: "+82" },
  { name: "Kuwait", iso: "kw", code: "+965" },
  { name: "Kyrgyzstan", iso: "kg", code: "+996" },
  { name: "Lao People's Democratic Republic", iso: "la", code: "+856" },
  ...
  { name: "Micronesia, Federated States of", iso: "fm", code: "+691" },
  { name: "Moldova, Republic of", iso: "md", code: "+373" },
  ...
  { name: "Palestine, State of", iso: "ps", code: "+970" },
  ...
  { name: "Puerto Rico", iso: "pr", code: "+1939" },
  { name: "Qatar", iso: "qa", code: "+974" },
  { name: "Romania", iso: "ro", code: "+40" },
  { name: "Russian Federation", iso: "ru", code: "+7" },
  { name: "Rwanda", iso: "rw", code: "+250" },
  { name: "Réunion", iso: "re", code: "+262" },
  { name: "Saint Helena, Ascension and Tristan da Cunha", iso: "sh", code: "+290" },
  ...
  { name: "Syrian Arab Republic", iso: "sy", code: "+963" },
  { name: "Taiwan, Province of China", iso: "tw", code: "+886" },
  { name: "Tajikistan", iso: "tj", code: "+992" },
  { name: "Tanzania, United Republic of", iso: "tz", code: "+255" },
  ...
  { name: "Venezuela, Bolivarian Republic of", iso: "ve", code: "+58" },
  { name: "Viet Nam", iso: "vn", code: "+84" },
  { name: "Virgin Islands, British", iso: "vg", code: "+1284" },
  { name: "Virgin Islands, U.S.", iso: "vi", code: "+1340" },
